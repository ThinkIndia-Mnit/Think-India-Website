...
const Navbar = () => {
  ...
  const closeBurgerMenu = () => {
    document.getElementById("burgerClose").classList.add("hidden");
    document.getElementById("burgerOpen").classList.remove("hidden");
    ...
    <nav className="sticky top-0 bg-black lg:px-4 md:px-4 border-gray-200 py-2.5 px-2 rounded dark:bg-gray-800">
      <div className="flex flex-wrap justify-between items-center mx-auto">
        ...
        <div className="hidden w-full md:block md:w-auto" id="mobileMenu">
          <ul className="flex flex-col mt-4 md:flex-row md:space-x-5 md:mt-0 md:text-sm md:font-medium items-center">
